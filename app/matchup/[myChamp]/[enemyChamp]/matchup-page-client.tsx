...
interface IMatchupPageClientProps {
  myChamp: string
  enemyChamp: string
...
export const MatchupPageClient = ({
  myChamp,
  enemyChamp,
  translations: t,
  language,
}: IMatchupPageClientProps) => {
  ...
  const myChampName = myChampion.name[language]
  const enemyName = enemy.name[language]
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-center gap-8">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <span className="font-semibold text-white">{myChampName}</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <span className="font-semibold text-white">{enemyName}</span>
          </div>
        </div>
      </div>
          ...
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {t.matchup.howToBeatWith
                ...
                .replace('{myChamp}', myChampName)}
            </CardTitle>
          </CardHeader>
          <CardContent>
            {matchup && matchup.tips[language].length > 0 ? (
              <TipList tips={matchup.tips} language={language} />
            ) : (
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {t.matchup.howToBeat.replace('{enemy}', enemyName)}
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {t.matchup.powerSpikes.replace('{champion}', enemyName)}
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {t.matchup.itemSpikes.replace('{champion}', enemyName)}
            </CardTitle>
          </CardHeader>
          <CardContent>
